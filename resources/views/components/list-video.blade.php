<div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
    ...
    <div class="grid gap-8 row-gap-5 mb-8 lg:grid-cols-3 lg:row-gap-8">
      ...
      <div>
        <img class="object-cover w-full h-56 mb-6 rounded shadow-lg md:h-64 xl:h-80" src="https://images.pexels.com/photos/3182750/pexels-photo-3182750.jpeg?auto=compress&amp;cs=tinysrgb&amp;dpr=2&amp;h=750&amp;w=1260" alt="" />
        <p class="mb-2 text-xl font-bold leading-none sm:text-2xl">
          Tunguska event
        </p>
        <p class="text-gray-700">
      ...
      <div>
        <img class="object-cover w-full h-56 mb-6 rounded shadow-lg md:h-64 xl:h-80" src="https://images.pexels.com/photos/3182746/pexels-photo-3182746.jpeg?auto=compress&amp;cs=tinysrgb&amp;dpr=2&amp;h=750&amp;w=1260" alt="" />
        <p class="mb-2 text-xl font-bold leading-none sm:text-2xl">
          Yolo ipsum dolor
        </p>
        <p class="text-gray-700">
      ...
      <div>
        <img class="object-cover w-full h-56 mb-6 rounded shadow-lg md:h-64 xl:h-80" src="https://images.pexels.com/photos/3184296/pexels-photo-3184296.jpeg?auto=compress&amp;cs=tinysrgb&amp;dpr=2&amp;h=750&amp;w=1260" alt="" />
        <p class="mb-2 text-xl font-bold leading-none sm:text-2xl">
          Curabitur mattis
        </p>
        <p class="text-gray-700">
      ...
      <div>
        <img class="object-cover w-full h-56 mb-6 rounded shadow-lg md:h-64 xl:h-80" src="https://images.pexels.com/photos/3184311/pexels-photo-3184311.jpeg?auto=compress&amp;cs=tinysrgb&amp;dpr=2&amp;w=500" alt="" />
        <p class="mb-2 text-xl font-bold leading-none sm:text-2xl">
          Leverage agile
        </p>
        <p class="text-gray-700">
      ...
      <div>
        <img class="object-cover w-full h-56 mb-6 rounded shadow-lg md:h-64 xl:h-80" src="https://images.pexels.com/photos/3184338/pexels-photo-3184338.jpeg?auto=compress&amp;cs=tinysrgb&amp;dpr=2&amp;h=750&amp;w=1260" alt="" />
        <p class="mb-2 text-xl font-bold leading-none sm:text-2xl">
          Organically grow
        </p>
        <p class="text-gray-700">
