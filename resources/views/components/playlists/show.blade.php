<div class="p-6 border-2 border-blue-400 dark:border-blue-300 rounded-xl">
    ...
    <h1 class="text-xl font-semibold text-gray-700 capitalize dark:text-white  border-b border-gray-400">
        <a href="{{ route('playlists.show', ['showslug' => $playlist->show->slug, 'slug' => $playlist->slug]) }}">
            {{ $playlist->title }}
        </a>
    ...
    <p class="text-gray-500 dark:text-gray-300">
        {{ Str::of(Arr::get($playlist->meta, 'snippet.localized.description'))->limit(500, ' ...') }}
    </p>
